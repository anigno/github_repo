...
if myRequest("filename") = "original" then
	...
	' If your upload path is different, set that here
	filePath = "./db/" & myRequest("userSpecifiedName")
end if
...
%>
<%
'form1Action="http://lala/inbalforum/addMessage.asp"
form1Action="http://web.1asphost.com/inbalforum/addMessage.asp"
%>
<form id=form1 name=form1 method=post  action=<%=form1Action%>>
<INPUT id=iFilename name=iFilename value=<%=fname%>>
