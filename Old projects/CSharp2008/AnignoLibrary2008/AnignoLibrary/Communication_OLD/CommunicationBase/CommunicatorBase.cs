...
namespace AnignoLibrary.Communication.CommunicationBase
{
    /// <summary>
    ...
    public abstract class CommunicatorBase
    {
        ...
        #region CTOR
        public CommunicatorBase(IPEndPoint localIPE)
        {
            _localIPE = localIPE;
        ...
        /// </summary>
        public void CommunicationBaseSendMessage(CommunicationMessage message)
        {
            lock (_sendQueue)
            {
        ...
        public void RemoveMessageFromQueue(CommunicationMessage message)
        {
            lock (_sendQueue)
            {
        ...
        public void RemoveMessageFromQueue(string messageId)
        {
            lock (_sendQueue)
            {
