...
{
    public partial class AnignoGraphDisplay : UserControl
    {
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            if(Width>0&&Height>0)_backBuffer = new Bitmap(Width, Height);
            DrawGraph();
        }
        ...
        {
            float ret= CalcDisplayY(pReal.Y);
            return ret;
        }
        ...
        public void ClearPointsAndGraph()
        {
            ClearPoints();
