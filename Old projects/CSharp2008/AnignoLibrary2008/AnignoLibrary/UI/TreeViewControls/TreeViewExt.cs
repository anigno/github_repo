...
namespace AnignoLibrary.UI.TreeViewControls
{
    ...
    public class TreeViewExt : TreeView
    {
        ...
        private readonly List<TreeNode> _checkedTreeNodesList = new List<TreeNode>();
        ...
        public List<TreeNode> CheckedTreeNodes
        {
            get
            {
                _checkedTreeNodesList.Clear();
                foreach(TreeNode node in Nodes)
                {
                    UpdateCheckedTreeNodesRecurse(node);
                }
                return _checkedTreeNodesList;
            }
        }
        ...
        {
            if(node.Checked)_checkedTreeNodesList.Add(node);
            foreach (TreeNode childNode in node.Nodes)
            {
