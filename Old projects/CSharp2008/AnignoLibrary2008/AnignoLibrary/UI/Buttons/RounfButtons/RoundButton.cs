...
namespace AnignoLibrary.UI.Buttons.RounfButtons
{
    ...
    public class RoundButton : System.Windows.Forms.Button
    {
        ...
        private const string CATEGORY_STRING = " RoundButton";
        ...
        private bool dome;
        // Centre colour for Path Gradient brushed
        private bool gotFocus = false;
        // Offset when button is pressed
        private float lightAngle = Angle.Up;
        private int recessDepth;
        private int bevelHeight;
        private int bevelDepth;
        //
        private int edgeWidth;
        // Width of button edge    
        private int buttonPressOffset;

        // For painting button edges
        private Blend edgeBlend;
        private Color buttonColor;
        // Blend colours for realistic edges
        private Color edgeColor1;
        // Change if button pressed
        private Color edgeColor2;
        // Alter light angle for "Pressed" effect
        private Color cColor = Color.White;
        // Determine if this button has focus
        private Font labelFont;
        // Used to align text on the control
        private GraphicsPath bpath;
        private GraphicsPath gpath;
        private LinearGradientBrush edgeBrush;
        // Create vertical text for this buttons
        ...
        [Bindable(true), Category(CATEGORY_STRING), 
         DefaultValue(false),
