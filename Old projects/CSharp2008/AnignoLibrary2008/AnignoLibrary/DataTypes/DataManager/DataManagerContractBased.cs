    ...
    public static class DataManagerContractBased<T> where T : class, new() 
    {
            ...
            get
            {
                lock (_syncRoot)
                {
                    lock (_syncRoot)
                    {
                        ...
                        if (_dataItem == null) Logger.LogError("Type: {0} returns null for DataItem", typeof (T));
                        return _dataItem;
                    }
                }
            }
        ...
        public static string DataFilePath
        {
            ...
            set
            {
                ...
                {
                    _dataFilePath = value;
                    Logger.LogDebug("DataFilePath was set to:{0}", _dataFilePath);
                }
            }
        }
        ...
        public static string DataFileName
        {
            ...
            set {
                ...
                {
                    _dataFileName = value;
                    Logger.LogDebug("DataFileName was set to:{0}",_dataFileName);
                }
            }
        }
        ...
        {
            Logger.LogInfo("DataManagerContractBased LoadDataItem() <{0}>", typeof(T));
            lock (_syncRoot)
            {
        ...
        {
            Logger.LogInfo("DataManagerContractBased SaveDataItem() <{0}>", typeof(T));
            lock (_syncRoot)
            {
                DataContractSerializer dcs=new DataContractSerializer(typeof(T));
                FileStream fs=null;
