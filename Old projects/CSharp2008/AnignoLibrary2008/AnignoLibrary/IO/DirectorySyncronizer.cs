...
namespace AnignoLibrary.IO
{
    ...
    public class DirectorySyncronizer
    {
        ...
        private void DirectoryCreate(string path)
        {
            ...
            {
                Logger.LogError(ex, "path: {0}", path);
        ...
        private void FileCopy(string sourceFilePath, string destFilePath)
        {
            ...
            {
                Logger.LogError(ex, "from: {0} to: {1}", sourceFilePath,destFilePath);
        ...
        {
            Logger.LogDebug("source: {0} dest: {1} keepHistory: {2}", source, dest, keepHistory);
            if (!Directory.Exists(source) )
            {
                Logger.LogWarning("Directory not found");
            ...
            //*** Sync copy
            FileSystemWalker2.OnFileFound += FileSystemWalker_OnFileFoundForSyncCopy;
            FileSystemWalker2.OnStart += FileSystemWalker2_OnStart;
            FileSystemWalker2.OnDirectoryEnter += FileSystemWalker2_OnDirectoryEnter;
            //Run walker
            FileSystemWalker2.WalkSync(sourceDir,sInclude,sExclude);
            FileSystemWalker2.OnFileFound -= FileSystemWalker_OnFileFoundForSyncCopy;
            FileSystemWalker2.OnStart -= FileSystemWalker2_OnStart;
            //*** Sync seek orphans
            FileSystemWalker2.OnDirectoryEnter += FileSystemWalker2_OnDirectoryEnter;
            FileSystemWalker2.OnFileFound += FileSystemWalker_OnFileFoundSeekOrphans;
            FileSystemWalker2.OnEnd += FileSystemWalker2_OnEnd;
            FileSystemWalker2.OnDirectoryExit += FileSystemWalker2_OnDirectoryExitSeek;
            //Run walker
            FileSystemWalker2.WalkSync(destDir,sInclude,sExclude);
            FileSystemWalker2.OnFileFound -= FileSystemWalker_OnFileFoundSeekOrphans;
            FileSystemWalker2.OnEnd -= FileSystemWalker2_OnEnd;
            FileSystemWalker2.OnDirectoryExit -= FileSystemWalker2_OnDirectoryExitSeek;
        }
