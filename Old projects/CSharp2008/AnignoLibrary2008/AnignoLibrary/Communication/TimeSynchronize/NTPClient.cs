...
namespace AnignoLibrary.Communication.TimeSynchronize
{
...
// NTP Data Structure Length
        ...
        public const string TIME_SERVER ="tick.usno.navy.mil";
        ...
        public static DateTime GetServerTime(bool SetLocalComputerTime)
        {
            NTPClient client=new NTPClient(TIME_SERVER);
            client.Connect(SetLocalComputerTime);
            return client.TransmitTimestamp;
        }
