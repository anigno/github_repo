...
public class JavaParser/*@bgen(jjtree)*/implements JavaParserTreeConstants, JavaParserConstants {/*@bgen(jjtree)*/
        ...
        //those two functions added to handle node's tokens
        //will be called on entry and exit every node
        void jjtreeOpenNodeScope(Node n){
                ((SimpleNode)n).firstToken=getToken(1);
                ((SimpleNode)n).otherToken=getToken(2);
                //anigno:
                //update token's connectedNode
                if(((SimpleNode)n).firstToken.connectedNode==null){
                        ((SimpleNode)n).firstToken.connectedNode=((SimpleNode)n);
                }//if
                //anigno
        }//jjtreeOpenNodeScope()
        ...
        //anigno: 0902050040
        //changed JJTJavaParserState jjtree from protected to public
   ...
   }// inner class ModifierSet

        //constructor, used in project
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      System.out.println("Java Parser Version 1.1:  Encountered errors during parse.");
          ...
          //check tree structure and tokens
